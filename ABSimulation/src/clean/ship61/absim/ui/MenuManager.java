...
public class MenuManager implements ActionListener {
	...
	public void createDefaultActions() {
		...
		JMenu demoMenu = addMenu(menuBar, "core.demo", "Demo", 'D', "Show preset demo");
		createMenuItem(demoMenu, "Demo 1", ' ', "Demo 1", this);
		createMenuItem(demoMenu, "Demo 2", ' ', "Demo 2", this);
		createMenuItem(demoMenu, "Demo 3", ' ', "Demo 2", this);

		JMenu runMenu = addMenu(menuBar, "core.run", "Run", 'R', "Run simulation");
		createMenuItem(runMenu, "Start", ' ', "Start running", this);
		createMenuItem(runMenu, "Pause/Resume", ' ', "Pause/Resume running", this);
		createMenuItem(runMenu, "Stop", ' ', "Stop running", this);
